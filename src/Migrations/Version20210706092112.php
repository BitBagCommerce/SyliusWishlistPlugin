 ...
 */
final class Version20210706092112 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE automatic_blacklisting_configuration_channel (automatic_blacklisting_configuration_id INT NOT NULL, channel_id INT NOT NULL, INDEX IDX_EB48A61172F5A1AA (channel_id), INDEX IDX_EB48A61142145D53 (automatic_blacklisting_configuration_id), PRIMARY KEY(automatic_blacklisting_configuration_id, channel_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE bitbag_admin_users_roles_resources (admin_user_id INT NOT NULL, role_resource_id INT NOT NULL, INDEX IDX_56F911DBB65C5AC (role_resource_id), INDEX IDX_56F911D6352511C (admin_user_id), PRIMARY KEY(admin_user_id, role_resource_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE bitbag_cms_block_channels (block_id INT NOT NULL, channel_id INT NOT NULL, INDEX IDX_8417B07372F5A1AA (channel_id), INDEX IDX_8417B073E9ED820C (block_id), PRIMARY KEY(block_id, channel_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE blacklisting_rule_channel (blacklisting_rule_id INT NOT NULL, channel_id INT NOT NULL, INDEX IDX_1311592272F5A1AA (channel_id), INDEX IDX_13115922968538BF (blacklisting_rule_id), PRIMARY KEY(blacklisting_rule_id, channel_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE blacklisting_rule_customer_group (blacklisting_rule_id INT NOT NULL, customer_group_id INT NOT NULL, INDEX IDX_C82ADBCAD2919A68 (customer_group_id), INDEX IDX_C82ADBCA968538BF (blacklisting_rule_id), PRIMARY KEY(blacklisting_rule_id, customer_group_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
