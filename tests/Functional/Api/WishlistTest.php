...
final class WishlistTest extends FunctionalTestCase
{
    ...
    //TODO investigate 'products' and 'productVariants' being included in the response
    public function test_user_can_create_wishlist(): void
    {
        ...
        $this->assertResponse($response, $this->getExpectedResponse('test_user_can_create_wishlist'), Response::HTTP_CREATED);
    }
    //TODO - Fix the tests
...
//        $response = $this->client->getResponse();
//
//        $this->assertResponse($response, $this->getExpectedResponse('test_admin_can_get_wishlists'), Response::HTTP_OK);
//    }
//
...
//
//        $response = $this->client->getResponse();
//        $this->assertResponse($response, $this->getExpectedResponse('test_user_can_get_wishlist_items'), Response::HTTP_OK);
//    }
//
...
//        $this->assertResponse($response, $this->getExpectedResponse('test_user_can_add_product_to_wishlist'), Response::HTTP_OK);
//    }
//
...
//        $this->assertNotNull($updatedWishlist);
//        $this->assertCount(1, $updatedWishlist->getWishlistProducts());
//        $this->assertResponse($response, $this->getExpectedResponse('test_user_can_add_product_variant_to_wishlist'), Response::HTTP_OK);
//    }
//
...
//    }
    ...
    private function getExpectedResponse(string $filename): string
    {
        return 'Api/WishlistTest/' . $filename;
    }
}
